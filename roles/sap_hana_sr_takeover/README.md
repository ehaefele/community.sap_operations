...
## Description
<!-- BEGIN Description -->
This role ensures controlled SAP HANA System Replication takeover operation.
<!-- END Description -->
  ...
  tasks:
    - name: Switch to hana1
      ...
      vars:
        ...
        sap_hana_sr_takeover_sid: "RHE"
        sap_hana_sr_takeover_instance_number: "00"
```
...
Select SAP HANA System ID.

## sap_hana_sr_takeover_instance_number
- **Required**
- _Type:_ `string`

Select SAP HANA System instance number.
